...
void test_oasis() {
    Oasis oasis = Oasis();
    oasis.addPlayer(100,828);
    oasis.addPlayer(90,20);
    oasis.addPlayer(80,5);

    oasis.addClan(222);

    oasis.joinClan(100,222);
    oasis.joinClan(90,222);
    oasis.joinClan(80,222);

    oasis.completeChallange(90,800);
    oasis.completeChallange(80,50);
    oasis.completeChallange(90,8);

   // int ptr,num;
  //  int *a;
 //   oasis.getBestPlayer(-5,&ptr);
   // cout<<ptr<<endl;

  //  oasis.getScoreboard(222,&a,&num);
  //  int x =9;
  //  oasis.joinClan(3122,207);

   // cout<<oasis.checkAccess(31227)<<endl;
  //  cout<<oasis.checkAccess(312)<<endl;
  //  cout<<oasis.checkAccess(3122)<<endl;
//}
